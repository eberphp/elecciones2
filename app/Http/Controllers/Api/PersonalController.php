...
class PersonalController extends Controller
{
    ...
    {
        $areas = Personal::with("_estado", "cargo", "funcion", "vinculo", "tipoUsuario", "_departamento", "_provincia", "_distrito", "tiposUbigeo")->where('personal.datos_empresa_id', idEmpresa())->where("registrado_en", "intranet");
        return DataTables::of($areas)->make(true);
    }
    public function paginationWeb(Request $request)
    {
        $areas = Personal::with("_estado", "cargo", "funcion", "vinculo", "tipoUsuario", "_departamento", "_provincia", "_distrito", "tiposUbigeo")->where('personal.datos_empresa_id', idEmpresa())->where("registrado_en", "web");
        return DataTables::of($areas)->make(true);
    }
