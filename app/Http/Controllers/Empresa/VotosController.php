...
class VotosController extends Controller
{
    ...
    public function encuestador(Request $request, Encuestas $encuesta)
    {
        ...
        return view('intranet.pages.empresa.encuestas.voto_encuestador', [
            'encuesta' => $encuesta,
    ...
    public function dispositivo(Request $request, $encuesta)
    {
        ...
        $departamentos = Departamento::where('estado', 'activo')->get();
        return view('intranet.pages.empresa.encuestas.voto_dispositivo', [
            'encuesta' => $encuesta,
            'departamentos' => $departamentos,
        ]);
    }
    ...
    {
        $departamentos = Departamento::where('estado', 'activo')->get();
        return view('intranet.pages.empresa.encuestas.voto_manual', [
            'encuesta' => $encuesta,
            'departamentos' => $departamentos,
        ]);
    }
    ...
    public function grafico(Request $request, Encuestas $encuesta)
    {
        ...
        return view('intranet.pages.empresa.encuestas.voto_graficos', [
            'encuesta' => $encuesta,
            'encuestas' => $encuestas,
    ...
    public function graficoPublico(Request $request,  $encuesta)
    {
        ...
        return view('intranet.pages.empresa.encuestas.voto_graficos_publico', [
            'encuesta' => $encuesta,
            'encuestas' => $encuestas,
            'porDispositivo' => $porDispositivo,
            'porEncuestador' => $porEncuestador,
