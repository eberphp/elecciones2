    ...
    <header class="slider slider-prlx fixed-slider text-center">
        <div class="swiper-container parallax-slider">
            ...
            <div class="social-icon">
                <a href="{{ $redes->facebook }}"><i class="fab fa-facebook-f"
                        style="color: {{ $redes->colorFondo }}"></i></a>
                <a href="{{ $redes->twitter }}"><i class="fab fa-twitter" style="color: {{ $redes->colorFondo }}"></i></a>
                <a href="{{ $redes->instagram }}"><i class="fab fa-instagram"
                        style="color: {{ $redes->colorFondo }}"></i></a>
                <a href="{{ $redes->whatsapp }}"><i class="fab fa-whatsapp" style="color: {{ $redes->colorFondo }}"></i></a>
                <a href="{{ $redes->linkedin }}"><i class="fab fa-linkedin"
                        style="color: {{ $redes->colorFondo }}"></i></a>
            </div>
        </div>
    </header>
                ...
                @endif --}}
                    ...
                    @if ($titulo->tituloServicioVisible == 'SI')
                        <div class="col-lg-12 wow fadeInLeft" data-wow-delay=".7s">
                            <div class="form-group has-error has-danger controls">
                                <select name="servicio" id="servicio" class="form-control form-group"
                                    onchange="redireciona()">
                                    <option value="null">{{ $titulo->titleServicio }}</option>

                                    @foreach ($servicios as $servicio)
                                        <option value="{{ $servicio->url }}"><a href="{{ $servicio->url }}"
                                                target="_blank">{{ $servicio->nombre }}</a></option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    @foreach ($botones as $boton)
                        <div class="col-lg-4 wow fadeInLeft" data-wow-delay=".5s">
                            <div class="form-group has-error has-danger controls">
                                <a href="{{ $boton->url }}" class="btn " target="_blank"
                                    style="width: 100%;background : {{ $boton->colorFondo }}; color:white;height: auto;
