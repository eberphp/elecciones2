                ...
                @foreach ($subpublicaciones as $publicacion)
                    @if ($publicacion->modeloBloque == 'Bloque 1')
                        ...
                        <div class="col-lg-12 wow fadeInLeft" style="margin-top: 1%;margin-bottom: 1%;">
                            @if ($publicacion->selecciona == 'Imagen')
                                <img src="{{asset('img/subpublicaciones/'.$publicacion->imagen)}}" alt=""style="width: 100%;">
                            @else
                        ...
                        <div class="col-lg-12 wow fadeInLeft" style="margin-top: 1%;margin-bottom: 1%;">
                            @if ($publicacion->selecciona == 'Imagen')
                                <a href="{{$publicacion->url}}" target="_blank"><img src="{{asset('img/subpublicaciones/'.$publicacion->imagen)}}" alt="" style="width: 100%;"></a>
                            @else
                            {!!$publicacion->linkVideo!!}
                            @endif
                            <br>
                    ...
                    @if ($publicacion->modeloBloque == 'Bloque 4')
                        ...
                        <div class="col-lg-3 col-6" style="text-align: left;margin-top: 1%;margin-bottom: 1%;padding-right: 0.5%;padding-left: 0.5%;">
                            @if ($publicacion->selecciona == 'Imagen')
                                <img src="{{asset('img/subpublicaciones/'.$publicacion->imagen)}}" alt="">
                            @else
                            {!!$publicacion->linkVideo!!}
                            @endif
                            <br>
                        ...
                        <div class="col-lg-3 col-6" style="margin-top: 1%;margin-bottom: 1%;padding-right: 0.5%;padding-left: 0.5%;">
                            @if ($publicacion->selecciona == 'Imagen')
                                <a href="{{ route('subpublicaciones', [$publicacion->datos_empresa_id, $publicacion->id])}}"  target="_blank"><img src="{{asset('img/subpublicaciones/'.$publicacion->imagen)}}" alt="" style="width: 100%;"></a>
                            @else
                            {!!$publicacion->linkVideo!!}
                            @endif
                            <br>
