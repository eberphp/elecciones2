                ...
                @foreach ($subpublicaciones as $publicacion)
                    @if ($publicacion->modeloBloque == 'Bloque 1')
                        ...
                        <div class="col-lg-12 wow fadeInLeft" style="margin-top: 1%;margin-bottom: 1%;">
                            @if ($publicacion->selecciona == 'Imagen')
                                <img src="{{asset('storage/img/subpublicaciones/'.$publicacion->imagen)}}" alt=""style="width: 100%;">
                            @else
                        ...
                        <div class="col-lg-12 wow fadeInLeft" style="margin-top: 1%;margin-bottom: 1%;">
                            @if ($publicacion->selecciona == 'Imagen')
                                <a href="{{$publicacion->url}}" target="_blank"><img src="{{asset('storage/img/subpublicaciones/'.$publicacion->imagen)}}" alt="" style="width: 100%;"></a>
                            @else
                            {!!$publicacion->linkVideo!!}
                            @endif
                            <br>
                        ...
                        <div class="col-lg-12 col-sm-12" style="margin-top: 1%;margin-bottom: 1%;">
                            @if ($publicacion->selecciona == 'Imagen')
                                <a href="{{ route('subpublicaciones', [$publicacion->datos_empresa_id, $publicacion->id])}}"  target="_blank"><img src="{{asset('storage/img/subpublicaciones/'.$publicacion->imagen)}}" alt="" style="width: 100%;"></a>
                            @else
                            {!!$publicacion->linkVideo!!}
                            @endif
                            <br>
                                ...
                                <div class="swiper-container parallax-slider">
                                    <div class="swiper-wrapper altutra">
                                        ...
                                        <div class="swiper-slide new-alturita-bloque-1" >
                                            <div class="bg-img valign" style="background-size: 100%!important;" data-background="{{ asset('storage/img/subpublicaciones/galeria/'.$imagen->imagen)}}" data-overlay-dark="6">
                                ...
                                <div class="swiper-container parallax-slider">
                                    <div class="swiper-wrapper altutra">
                                        ...
                                        <div class="swiper-slide new-alturita" >
                                            <div class="bg-img valign" style="" data-background="{{ asset('storage/img/subpublicaciones/galeria/'.$imagen->imagen)}}" data-overlay-dark="6">
                    ...
                    @if ($publicacion->modeloBloque == 'Bloque 4')
                        ...
                        <div class="col-lg-3 col-6" style="text-align: left;margin-top: 1%;margin-bottom: 1%;padding-right: 0.5%;padding-left: 0.5%;">
                            @if ($publicacion->selecciona == 'Imagen')
                                <img src="{{asset('storage/img/subpublicaciones/'.$publicacion->imagen)}}" alt="">
                            @else
                            {!!$publicacion->linkVideo!!}
                            @endif
                            <br>
                                ...
                                <div class="swiper-container parallax-slider">
                                    <div class="swiper-wrapper altutra">
                                        ...
                                        <div class="swiper-slide new-alturita-bloque-4" >
                                            <div class="bg-img valign alineacion-center" style="background-size: 100%!important;" data-background="{{ asset('storage/img/subpublicaciones/galeria/'.$imagen->imagen)}}" data-overlay-dark="6">
                                ...
                                <div class="swiper-container parallax-slider">
                                    <div class="swiper-wrapper altutra">
                                        ...
                                        <div class="swiper-slide" style="min-height: 43vh!important;">
                                            <div class="bg-img valign" style="background-size: 100%!important;background-position: center!important;" data-background="{{ asset('storage/img/subpublicaciones/galeria/'.$imagen->imagen)}}" data-overlay-dark="6">
