...
@section('contenido')
    <div class="row ">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a class="btn btn-sm text-white" style="background: #406ccc"
                                                    href="{{ route('menu.edit', $d->idMenu) }}">
                                                    <i class="far fa-edit"
                                                        title="EDITAR MENU {{ $d->codMenu }}"></i>
                                                </a>
                                            
                                        </td>
                                        <td class="text-center">
                                            
                                            <form action="{{ route('menu.destroy', $d->idMenu) }}"
                                                style="margin-bottom: 0px" method="POST">
                                                {!! csrf_field() !!}
                                                {!! method_field('DELETE') !!}
                                                <button class="btn btn-danger borrar btn-sm"
                                                    title="ELIMINAR MENU {{ $d->codMenu }}"
                                                    data-nombre="{{ $d->codMenu }}"><i class="fas fa-trash"
        ...
        {{-- @include('configuracion.menu.create') --}}
    </div>
