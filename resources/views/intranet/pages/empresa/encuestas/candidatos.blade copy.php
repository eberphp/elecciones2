                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-sm font-weight-normal d-flex">
                                    <a href="{{ route('elimina-candidatos', $candidato->id) }}" class="btn btn-danger mx-1"> <i class="fa fa-trash"></i> </a>
                                    <button type="button"
                                    class="btn btn-success"
                                    data-bs-toggle="modal"
                                    data-bs-target="#exampleModalEdit{{ $key }}"><i class="fa fa-edit"></i></button>
                                </td>
