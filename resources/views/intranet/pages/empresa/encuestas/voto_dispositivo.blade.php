                            ...
                            fila += ` 
                                    <div class="px-2 py-1 mt-1 text-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center mt-1" >
                                            <label for="r${res[i].Regional[0].id}" style="text-align: unset;"><h6 class="mb-0" style="font-size:10px;cursor:pointer;">${res[i].Regional[0].nombreCorto}</h6></label>
                                        </div>
                                    </div>                                    
                                    `;
                        }
                        ...
                        if (res[i].Provincial.length > 0) {
                            fila += `
                                <div class="px-2 py-1 mt-1 text-center">
                                    ...
                                    <div class="d-flex flex-column justify-content-center mt-1" >
                                        <label for="p${res[i].Provincial[0].id}" style="text-align: unset;"><h6 class="mb-0" style="font-size:10px;cursor:pointer;">${res[i].Provincial[0].nombreCorto}</h6></label>
                                    </div>
                                </div>`;
                        }
                        ...
                        if (res[i].Distrital.length > 0) {
                            fila += `
                                <div class="px-2 py-1 mt-1 text-center">
                                    ...
                                    <div class="d-flex flex-column justify-content-center mt-1" >
                                        <label for="d${res[i].Distrital[0].id}" style="text-align: unset;"><h6 class="mb-0" style="font-size:10px;cursor:pointer;">${res[i].Distrital[0].nombreCorto}</h6></label>
                                    </div>
                                </div>`;
                        }
                        fila += `</td>
