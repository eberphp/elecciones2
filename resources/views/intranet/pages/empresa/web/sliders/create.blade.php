        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6"><h5 class="mb-0">Crear Slider</h5></div>
                        <div class="col-6">
                    ...
                    <form action="{{ route('sliders.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                <label for="">ID</label>
                                <?php $contador = App\Models\Slider::where('datos_empresa_id', auth()->user()->id)->get(); ?>
                                <input type="text" name="id" class="multisteps-form__input form-control" value="{{count($contador) + 1}}" disabled>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
