        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6"><h5 class="mb-0">Crear SubPublicacion</h5></div>
                        <div class="col-6">
                ...
                <div style="padding-left: 10%;padding-right:10%;padding-top:3%;padding-bottom:5%;">
                    <form action="{{ route('subpublicaciones.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                <input type="text" name="pubicacion_id" class="multisteps-form__input form-control" value="{{$publicacion->id}}" hidden>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                <label for="">ID</label>
                                <?php $subpublicaciones = App\Models\Subpublicacion::where('datos_empresa_id', auth()->user()->id)->get(); ?>
