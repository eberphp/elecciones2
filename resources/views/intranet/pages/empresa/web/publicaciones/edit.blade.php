        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6"><h5 class="mb-0">Editar Publicacion</h5></div>
                        <div class="col-6">
                    ...
                    <form action="{{ route('publicaciones.update', $publicacion->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="nombre" class="multisteps-form__input form-control" value="{{$publicacion->nombre}}">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                <label for="">Orden</label>
                                <input type="number" name="orden" class="multisteps-form__input form-control" value="{{$publicacion->orden}}">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                <label for="">URL</label>
                                <input type="text" name="url" class="multisteps-form__input form-control" value="{{$publicacion->url}}">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                <label for="">Texto</label>
                                <textarea class=" multisteps-form__input form-control ckeditor" name="texto" id="editor1" rows="10" cols="58">{{$publicacion->texto}}</textarea>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <select name="idConfiguracion" id="" class="multisteps-form__input form-control" value="{{$publicacion->idConfiguracion}}">
                                    <?php $configuracionAux = App\Models\Configuracion::find($publicacion->idConfiguracion); ?>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <br>
                                <select name="modelo" id="" placeholder="Modelo de Bloque" class="multisteps-form__input form-control" value="{{$publicacion->modeloBloque}}">
                                    <option value="{{$publicacion->modeloBloque}}">{{$publicacion->modeloBloque}}</option>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <select name="selecciona" id="" class="multisteps-form__input form-control" value="{{$publicacion->selecciona}}">
                                    <option value="{{$publicacion->selecciona}}">{{$publicacion->selecciona}}</option>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" name="video" class="multisteps-form__input form-control" value="{{$publicacion->linkVideo}}">
                            </div>
                        </div>
